// Use SortUtil.vw  // Activate_SortUtil_Vw (for use in the DFMatrix environment)
...
object oSortUtil_Vw is a aps.View label "Reindexing of tables"
  ...
  procedure DoSortTables
    send DoSort to (oLst(self))
  end_procedure
  ...
  object oBtn2 is a aps.Multi_Button
    on_item "Sort tables" send DoSortTables
  end_object
